package team6.car.global.error.handler;
...
import team6.car.global.error.dto.ErrorResponse;
import team6.car.global.error.exception.BusinessException;
...
public class GlobalExceptionHandler {
    ...
    */
    ...
    protected ResponseEntity<ErrorResponse> handleNoResoureException(final NoSuchElementException e) {
        log.error(">>> handle: NoResoureException ", e);
        final ErrorResponse errorBaseResponse = ErrorResponse.of(ErrorCode.RESOURCE_NOT_FOUND);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorBaseResponse);
    }
